...
//Weboldalt felépítő Script 
    ...
    document.getElementByClassName("content")[0].innerHTML = this.responseText;
    if (user == "dark") { 
		darkt_theme();
    }
	cookieinformation();
